"""
Django settings for cmmc_38677 project.
...
WSGI_APPLICATION = 'cmmc_38677.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cmmc_38677 API",
    "DESCRIPTION": "API documentation for cmmc_38677 App",
    "VERSION": "v1",
}
